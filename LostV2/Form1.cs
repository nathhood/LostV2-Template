/// created by : Nathan Hood & Nathan Rison
/// date       : 9 November 2018
/// description: A CS:GO text adventure game using ingame features
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (scene)
            {
                case 0:  //start scene  
                    ...
                    break;
                case 1:
                    outputLabel.Text = "You have no money to buy an AWP. You get an M4A4 and armor. Do you go B site or Lower Tunnels?";
                ...
                case 12:
                    painSound.Play();
                    outputLabel.Text = "You get taken out without killing anybody. Your team cant retake the site without you. You lose.";
                    redLabel.Text = "";
                    blueLabel.Text = "";
                    greenLabel.Text = "Restart";
                    break;
